...
class Applications(models.Model):
    subject = models.CharField("Тема письма", max_length=500)  
    ...
    class Meta: #метаданные для админских настройках
        verbose_name = 'Заявка'
...
class ApplicationAudit(models.Model):
    ACTION_APPROVED = "approved" #одобрено
    ACTION_REJECTED = "rejected" #отклонено
    ACTION_PROCESSED = "processed" #обработано
    ACTIONS = [
