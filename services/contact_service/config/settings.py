...
ALLOWED_HOSTS = [
    'localhost', '127.0.0.1', '0.0.0.0',
    'user-service', 'api-gateway', 'contact-service', 'calendar', 'marketing', 'documents', 'applications'
]
...
# В контакт-сервисе используется только своё приложение contacts.
LOCAL_APPS = [
    'apps.contacts',
]
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': BASE_DIR / 'databases' / 'applications.db',
    }
}
