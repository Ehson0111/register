...
#         if client_info:
#             # Основные поля клиента (адаптируйте под свою структуру БД)
#             variables.update({
...
#                 'company': client_info.get('company', '')  # если есть поле компании у клиента
#             })
...
#             # Можно добавить данные менеджера, если нужно
#         })
...
#             recipient_id=recipient_id,
#             client_info=client_info,
#             template_variables=variables  # НОВЫЙ ПАРАМЕТР
#         )
...
#                 'message': f'Сообщение отправлено клиенту #{recipient_id}',
#                 'campaign_id': campaign.id,
#                 'variables_used': variables,  # Возвращаем какие переменные были использованы
#                 'recipient': {
#                     'id': recipient_id,
#                     'info': client_info
#                 }
...
#     # _get_client_info метод остается без изменений
